...
from voxel.tools import read_dict, scale_dict
...
weights_path = os.path.join(current_directory, '../weights/')
...
class PDB_backbone(object):
    ...
    def get_weights(self, weights='hydropathy', scaling=True):
        ...
        # Select weights
        weights = read_dict(os.path.join(weights_path, weights + '.csv'))
